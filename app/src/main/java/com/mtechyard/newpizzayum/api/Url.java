...
public class Url {
    ...
    public static final String CREATE_ORDER = domain + dir1 + "createOrder.php";
    public static final String CHANGE_ORDER_STATUS = domain + dir1 + "change_status.php";
    public static final String TOPPING_LINKS = domain + dir1 + "toppingList.php";
}
